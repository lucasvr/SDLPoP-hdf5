Prince of Persia: HDF5-UDF mod
==============================

This clone contains modifications to allow Prince of Persia's game framebuffer to be exported through a System V
shared memory segment. This modification has been introduced to demonstrate how user-defined functions embedded
in HDF5 files can interface with other processes in unexpected ways. Please visit the HDF5-UDF project page
at https://github.com/lucasvr/hdf5-udf for more details.
